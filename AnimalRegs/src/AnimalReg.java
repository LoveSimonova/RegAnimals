...
public class AnimalReg implements AutoCloseable {
  ...
  public static void main(String[] args) throws Exception {
    try (AnimalReg animalReg = new AnimalReg()) {
            ...
            case 1:
              ...
              switch (type) {
                ...
                case "Camel":
                  ...
                  break;
                case "Mule":
                  animal = new Mule(name);
                  break;
                default:
                  throw new IllegalStateException("Unexpected value: " + type);
              }
              animalReg.addNewAnimal(animal);
              break;
            case 2:
              System.out.println("Enter animal name: ");
              String animalName = scanner.nextLine();
              Animal foundAnimal = animalReg.animals.stream()
              ...
              animalReg.teachCommand(foundAnimal, command);
              break;
            case 3:
              System.out.println("Enter animal name: ");
              String aName = scanner.nextLine();
              Animal fAnimal = animalReg.animals.stream()
              ...
              List<String> commands = animalReg.getCommands(fAnimal);
